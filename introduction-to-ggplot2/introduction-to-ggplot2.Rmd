...
cover-image: Intro-to-ggplot2-Forest.png
---
...
```{r, eval = TRUE, echo = FALSE, fig.height = 3.0}

library(png)

library(grid)

cover <- readPNG("Intro-to-ggplot2-Forest.png")
...
group <- rbinom(n = N, 
                1, 
                .5) # n, number of trials, probability
...
More ggplot2 examples can be found [here](http://www-personal.umich.edu/~agrogan/how_to_choose_a_chart/how_to_choose_a_chart_v3.html).

*****

Graphics made with the [ggplot2](https://ggplot2.tidyverse.org/) graphing library created by Hadley Wickham.

Available online at [https://agroganweb.wordpress.com/data-visualization-dataviz/](https://agroganweb.wordpress.com/data-visualization-dataviz/)
