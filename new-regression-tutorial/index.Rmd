...
My best guess about the slope is drawn as a purple line.   It looks like for every hour run, on average, runners run just under 5 miles, so let’s say 4.9 miles per hour.

I also need to think about where the line crosses, or intercepts, the y-axis.

I’ve extended the line in green and marked my estimate of the y-intercept.
...
distance = starting place + speed * hours
...
It turns out our estimate of slope (4.9) was pretty close to what the computer finds (4.71) , while our estimate that the intercept was 0 is a little bit different from the computer’s estimate (.714).  According to the computer, the best guess is that the average runner had a little bit of a head start.
