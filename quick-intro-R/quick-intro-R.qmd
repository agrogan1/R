...
![A common data workflow](workflow.png){width=90%} 
...
library(skimr) # excellent library for summarizing data

skim(mydata) # look at data

skim(mydata$x) # look at particular variable
